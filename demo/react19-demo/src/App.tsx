  ...
  return (
    <vg-theme-provider mode={theme} onvg-change={e=>console.log(e)}>
      <vg-card heading="Theme controls" variant="subtle">
        ...
        >
          <svg slot="prefix" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...{ slot: "prefix" } as any}>
